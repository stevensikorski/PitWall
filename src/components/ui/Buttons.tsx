...
import { MdOutlineQuestionMark, MdOutlineKeyboardArrowRight } from "react-icons/md";
import { SiBuymeacoffee } from "react-icons/si";
import { linkedin_url, github_url, buymeacoffee_url, xtwitter_url, instagram_url } from "@/constants/constants";

export const ChatButton = () => {
  return (
    <Link href={"/chat"} className="size-10 desktop:size-8 mr-3 desktop:mr-2 bg-neutral-950 desktop:hover:bg-white rounded-lg border border-neutral-800 flex justify-center items-center transition duration-200 group">
      <IoChatboxEllipsesSharp className="size-4 text-neutral-400 desktop:group-hover:text-black transition duration-200" />
    </Link>
  );
};
...
export const HelpButton = () => {
  return (
    <Link href={"/help"} className="size-10 desktop:size-8 mr-3 desktop:mr-0 bg-neutral-950 desktop:hover:bg-white rounded-lg border border-neutral-800 flex justify-center items-center transition duration-200 group">
      <MdOutlineQuestionMark className="size-4 text-neutral-400 desktop:group-hover:text-black transition duration-200" />
    </Link>
  );
};
...
export const NewButton = () => {
  return (
    <Link href={"/chat"} className="size-10 mr-2 bg-neutral-950 desktop:hover:bg-white rounded-lg border border-neutral-800 flex justify-center items-center transition duration-200 group">
      <FaPlus className="size-4 text-neutral-400 desktop:group-hover:text-black transition duration-200" />
    </Link>
  );
};
...
export const SubmitButton = () => {
  return (
    <button className="size-10 ml-2 bg-neutral-950 desktop:hover:bg-white rounded-lg border border-neutral-800 flex justify-center items-center transition duration-200 group">
      <IoIosSend className="size-4 text-neutral-400 desktop:group-hover:text-black transition duration-200" />
    </button>
  );
};
...
export const PanelButton: React.FC<{ text: string }> = ({ text }) => {
  return (
    <button className="flex items-center mb-2 gap-2 group">
      <MdOutlineKeyboardArrowRight className="size-5 text-neutral-700 group-hover:translate-x-0.5 group-hover:text-neutral-200 transition duration-200" />
      <p className="font-medium group-hover:text-neutral-200 transition duration-200">{text}</p>
    </button>
  );
};

  ...
  return (
    <div className="h-auto pb-2">
      ...
      <div className="h-auto w-full flex py-1">
        ...
        <button className="size-8 mr-2 flex justify-center items-center relative outline-none" onClick={handlePlayPause}>
        ...
        <div className="w-full flex items-center">
          ...
          <p className="w-16 ml-2 text-center text-xs font-medium text-neutral-700">{currentTime === 0 ? new Date(duration * 1000).toISOString().substring(14, 19) : new Date(currentTime * 1000).toISOString().substring(14, 19)}</p>
        </div>
      </div>
    </div>
  );
